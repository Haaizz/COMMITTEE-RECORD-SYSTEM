...
<div class="table-container">
    ...
    <tr>
        <th>User Photo</th>
        <td style="width: 300px; height: 300px; object-fit: cover;">
            <img src="<?php echo $user_data['photo']; ?>" alt="" style="max-width: 100%; max-height: 100%;">
        </td>
    </tr>
    <?php
} else {
    ...
    <tr>
        ...
        <td style="width: 100px; height: 100px; object-fit: cover;">
            <img src="placeholder.jfif" alt="" style="max-width: 100%; max-height: 100%;">
        </td>
    </tr>
            <?php
         }
